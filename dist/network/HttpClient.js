...
var HttpClient = /** @class */ (function () {
    function HttpClient(httpClientOptions) {
        this.request = rp;
        this.cookieJar = rp.jar();
        this.clientOptions = httpClientOptions;
    }
    HttpClient.createClient = function (httpClientOptions) {
        if (httpClientOptions === void 0) { httpClientOptions = null; }
        return new HttpClient(httpClientOptions);
    };
    HttpClient.getInstance = function (httpClientOptions) {
        if (httpClientOptions === void 0) { httpClientOptions = null; }
    ...
    HttpClient.prototype.get = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.request(Object.assign({ jar: this.cookieJar }, { method: 'GET' }, options))];
            });
        });
    };
    HttpClient.prototype.post = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.request(Object.assign({ jar: this.cookieJar }, { method: 'POST' }, options))];
            });
        });
    };
    return HttpClient;
